...
<ComicSection cols={9} elements={[
    {type:"image", src: "/loc/sewy/knight/k2.png", position:{col:1, row:1}, size:{width:9, height:7}},
    {type:"image", src: "/loc/sewy/knight/k3.png", position:{col:1, row:8}, size:{width:9, height:7}}
]}/>
