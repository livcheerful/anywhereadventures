...
<ComicSection cols={9} rowHeight="2 rem" elements={[
    {type:"image", src: "/loc/sewy/morris/e1.png", position:{col:1, row:2}, size:{width:9, height:7}},
    {type:"image", src: "/loc/sewy/morris/e2.png", position:{col:1, row:9}, size:{width:9, height:7}}
]}/>
I won’t do it!
...
<ComicSection cols={9} rowHeight="2 rem" elements={[
    {type:"image", src: "/loc/sewy/morris/e3.png", position:{col:1, row:2}, size:{width:9, height:7}}
]}/>
...
<ComicSection cols={9} rowHeight="2 rem" elements={[
    {type:"image", src: "/loc/sewy/morris/e4.png", position:{col:1, row:2}, size:{width:9, height:7}}
]}/>
okay I see where you’re coming from. Case dismissed
