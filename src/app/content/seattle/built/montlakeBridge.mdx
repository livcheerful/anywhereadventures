...
If you want to learn more about the bridge's history and how it works, you can read the full engineering report below, which states: “Only in America could football become a justification for building a bridge.” This is reference to the construction of the University of Washington's Husky Stadium built across the cut in 1920, just a few years prior. Before the bridge a pedestrian pontoon bridge was added so that people could easily get to games.
