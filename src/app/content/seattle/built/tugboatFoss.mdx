...
stickers: [{image: "/loc/seattle/tugboatFoss/boat.png" }, {image: "/loc/seattle/tugboatFoss/fossEmblem.png", linkOut: "https://www.loc.gov/resource/hhh.wa0868.photos/?sp=1", title: "Foss Company motto on the side of the boat"}]
---
...
<ComicSection elements={[
    ...
    {type:"text", src:"... Is that how you always smile?", position:{col: 3, row: 5}, size: {width:1, height: 1}, style:{outline: "bubble",}, },
]}/>
