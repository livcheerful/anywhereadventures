...
<ComicSection elements={[
    ...
    {type:"text", src:"When Susan B. Anthony Visited Seattle, She stayed at the Occidental I.", style:{outline: "bubble"},position:{col:1, row:1}, size:{width:2, height:1}, bubbleStyle: {tailDegree: 0}},
