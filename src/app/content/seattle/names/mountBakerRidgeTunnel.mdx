...
<ComicSection overlap={50} rowHeight="4rem" elements={[
    ...
    {type:"image", alt:"A brightly colored drawing of Homed Hadley mid-sentence.", src:"/loc/seattle/bridgeAndTunnel/murrow.png",position:{col:1, row:9}, size:{width:1, height:2}}, 
