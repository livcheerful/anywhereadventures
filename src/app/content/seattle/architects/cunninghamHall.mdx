...
<ComicSection cols={6} rowHeight="3rem" elements={[
    {type:"image", src:"/loc/seattle/cunninghamHall/moving.png", alt:"A black and white comic panel showing a giant person carrying a small building in its arms while it walks through a miniature cityscape. The person is looking down trying to figure out where to place the building it's carrying.", position:{col:1, row:4}, size:{width:6, height:6}},
...
HOWEVER this is, surprisingly, not always true, as demonstrated by Cunningham Hall. 
...
<LOCItem
    type="map"
    caption="Authorized bird's eye view of the Alaska-Yukon-Pacific Exposition."
...
Cunningham Hall was designed by architects Saunders and Lawton, whose together designed many buildings around Seattle, including the old Beacon Hill Elementary School and the Alaska Building in Pioneer Square. They also designed the Hoo Hoo House for the AYP.
...
<ComicSection cols="6" rowHeight="3rem" elements={[
    ...
    {type:"text", src:"But it's too tall - we'd have to move the bridge. If we take it through campus, we will have to cut down less trees too.", position:{col:4, row:2}, size:{width:3, height:2}, style:{outline: "bubble"}},
...
Cunningham being too light meant that the dollies weren’t carrying enough weight, and instead of moving in one consistent direction, they would freely spin, which made it very difficult to move (like when your shopping cart has a wheel that misbehaves). The other problem was the path the building planned to take across campus. The building would need to cross Red Square, which housed the underground parking garage, Central Plaza Garage. 
...
Somehow, Cunningham Hall was both too heavy and too light. Despite all the (metaphorical) roadblocks, the 100 year old two-story building was moved .3 miles to its new home! 
