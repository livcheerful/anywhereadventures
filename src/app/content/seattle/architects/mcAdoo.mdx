...
<ComicSection rowHeight="2rem" cols={7} elements={[
    {type:"image", alt:"A drawing of the clinic of Dr. Joyner, a one-story building built of brick.",src:"/loc/seattle/mcAdoo/clinic.png", position:{col:1, row:2}, size:{width:7, height:8}},
